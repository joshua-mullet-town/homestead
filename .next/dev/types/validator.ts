...
// Validate ../../../app/api/droplets/status/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/droplets/status">> = Specific
  const handler = {} as typeof import("../../../app/api/droplets/status/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
